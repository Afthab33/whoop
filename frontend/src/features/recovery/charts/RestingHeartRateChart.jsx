// src/components/dashboard/recovery/charts/RestingHeartRateChart.jsx
...
const RestingHeartRateChart = () => {
  ...
  const rhrData = [
    ...
    { day: 'Mon', date: '14', value: 60 },
    { day: 'Tue', date: '15', value: 65 },
    { day: 'Wed', date: '16', value: 69 },
    { day: 'Thu', date: '17', value: 64 },
    { day: 'Fri', date: '18', value: 64 },
    { day: 'Sat', date: '19', value: 63, isToday: true }
  ];
  ...
  const renderCustomXAxisTick = (props) => {
    ...
    const data = rhrData[payload.index];
  ...
  return (
    <div className="whoops-card p-6">
      <div className="flex items-center mb-6">
        ...
        <h2 className="text-xl font-bold text-[var(--text-primary)]">RESTING HEART RATE</h2>
      </div>
